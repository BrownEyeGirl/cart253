...
/**
 * Starts the ball moving on mouse pressed (preset event listener)
 */
function mousePressed() {
    ball.velocity.x = ball.speed; // sets ball speed
}

/**
 * Stops the ball moving (preset event listener)
 */
...
/**
 * Grows the ball when the mouse wheel is rolled (preset event listener)
 */
function mouseWheel() {
    ball.size += 0.5;
}
